...
※本システムを基に機能増設したシステムはこちら

> [!TIP]
> **🚀 機能拡張版（AI・マイク入力対応）を公開しました**
> 本システムをベースに、**AI会話機能**や**マイク入力（漢字・カタカナ対応）**を追加した新しいツールです。より高度な機能を利用したい方は以下をご参照ください。
>[![New Version](https://img.shields.io/badge/New_System-Available-brightgreen?style=for-the-badge&logo=github)](https://github.com/aki-oid/SemaphorAI)
